    ...
    extend: {
      colors: {
        ...
        tab: {
          ...
          underline: "hsl(var(--tab-underline))",
        },
        selection: {
          border: "hsl(var(--selection-border))",
          fill: "hsl(var(--selection-fill))",
        },
        mask: {
          light: "hsl(var(--mask-light))",
          dark: "hsl(var(--mask-dark))",
          white: "hsl(var(--mask-white))",
          black: "hsl(var(--mask-black))",
        },
        document: {
          bg: "hsl(var(--document-bg))",
          page: "hsl(var(--document-page))",
        },
        tooltip: {
